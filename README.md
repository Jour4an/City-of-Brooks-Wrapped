...
<head>
    ...
    <title>Brooks Property Tax Year in Review</title>
    ...
    <style>
        ...
        /* Set base for full-screen, no-scroll experience */
        html, body {
            height: 100%;
            width: 100%;
            overflow: hidden; /* Crucial: disables main body scrolling */
            margin: 0;
            padding: 0;
        ...
        .wrapped-container {
            ...
            height: 100%; 
            width: 100%; 
            max-width: none; /* Removed width constraint for the full-screen effect */
            overflow: hidden; 
            position: relative;
        ...
        /* The inner wrapper ensures content is centered and doesn't get too wide on massive screens */
        .content-wrapper {
        ...
        .slide-page {
            ...
            height: 100vh;
            padding: 40px 0; /* Vertical padding only, inner wrapper handles horizontal padding */
            display: flex;
        ...
        #page-4 .content-wrapper {
            ...
            padding-bottom: 80px; /* Space from bottom nav */
            overflow-y: auto; /* Allow scrolling ONLY on this page */
            display: block; /* Use block layout for flow */
        }
        ...
        /* --- Navigation Button Styles (New Bottom Position) --- */
        ...
        .nav-button {
            background-color: var(--color-wrapped-primary);
            color: white;
            padding: 0.75rem;
...
<body class="p-0">
    ...
    <!-- Navigation Controls Container (Fixed position, outside slides) -->
    <div class="nav-buttons-container">
        <!-- Previous Button (Up Arrow) -->
        <button id="prev-button" class="nav-button" onclick="prevPage()">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
            </svg>
        </button>
        <!-- Next Button (Down Arrow) -->
        <button id="next-button" class="nav-button" onclick="nextPage()">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-6 h-6">
    ...
    <div id="wrapped-content" class="wrapped-container border-4 border-white/10">
        ...
        <!-- Slides Wrapper for Vertical Movement -->
                ...
                <div class="content-wrapper flex flex-col items-center justify-center">
                    <div class="text-center mb-6 max-w-2xl">
                        ...
                        <p class="text-lg font-medium mt-3 text-white/90 max-w-sm mx-auto">
                            Ever wondered where your 2025 property taxes went? Here’s your personalized breakdown—just enter your assessment!
                        </p>
                    </div>
                    ...
                    <div class="mb-10 input-card p-6 rounded-xl text-center max-w-md w-full">
                        ...
                        <p class="text-xs mt-3 text-white/50 text-center font-inter">
                            Based on 2025 Mill Rate: <span id="millRateDisplay2025" class="font-bold text-white/70"></span> per $1,000
                        </p>
                    </div>
                    <!-- Disclaimer and Footnote -->
                    <div class="mt-auto pt-8 text-center max-w-2xl">
                        <p class="text-sm font-semibold text-white/60 mb-2">
                            This isn’t a tax notice—just a fun way to see how your dollars worked for Brooks this year.
                        </p>
                        <p class="text-xs text-white/40">
                            Disclaimer: For reference only—actual tax notices were sent in May.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div id="page-2" class="slide-page">
                <div class="content-wrapper flex flex-col items-center justify-center text-center">
                    ...
                    <p class="text-xl mt-6 text-white/80">
                        That's your contribution to the City of Brooks for the year.
                    </p>
                </div>
            </div>
            ...
            <div id="page-3" class="slide-page">
                <div class="content-wrapper flex flex-col items-center justify-center text-center">
                    ...
                    <p class="text-xl text-white/70 mb-8 font-inter">
                        This is how your total tax of <span id="taxValuePlaceholder" class="font-extrabold text-wrapped-secondary">$0.00</span> was divided:
                    </p>
                ...
                <div class="content-wrapper flex flex-col items-center justify-center text-center">
                    ...
                    <ul class="space-y-6 max-w-3xl w-full">
                        <li class="flex items-center p-4 rounded-xl border border-white/20 hover:border-wrapped-primary transition duration-300 text-left" style="background-color: #2e2e2e;">
                            <span class="text-4xl mr-4 leading-none">💧</span>
                            <span class="font-bold text-xl">Water Supply & Treatment</span>
                        </li>
                        <li class="flex items-center p-4 rounded-xl border border-white/20 hover:border-wrapped-primary transition duration-300 text-left" style="background-color: #2e2e2e;">
                            <span class="text-4xl mr-4 leading-none">♻️</span>
                ...
                <div class="content-wrapper flex flex-col items-center justify-center text-center">
                    ...
                    <ul class="space-y-4 max-w-3xl w-full text-left">
                        <li class="flex items-start text-white/80 p-3 rounded-md border-l-4 border-wrapped-secondary">
                            <span class="text-wrapped-secondary mr-3 text-xl leading-none">🚧</span>
                        ...
                        <li class="flex items-start text-white/80 p-3 rounded-md border-l-4 border-wrapped-primary">
                            <span class="text-wrapped-primary mr-3 text-xl leading-none">🌳</span>
                        ...
                        <li class="flex items-start text-white/80 p-3 rounded-md border-l-4 border-wrapped-tertiary">
                            <span class="text-wrapped-tertiary mr-3 text-xl leading-none">🛹</span>
    ...
    <script>
        ...
        function updateSlidePosition() {
            ...
            const offset = -currentPageIndex * viewportHeight;
            wrapper.style.transform = `translateY(${offset}px)`;
            
            // Update button visibility
            prevButton.style.display = currentPageIndex > 0 ? 'flex' : 'none';
            // Hide next button on the last page
            nextButton.style.display = currentPageIndex < totalPages - 1 ? 'flex' : 'none';
        }

        function nextPage() {
            if (currentPageIndex < totalPages - 1) {
                currentPageIndex++;
                calculateTaxes(); // Ensure data is current on page change
                updateSlidePosition();
            }
        }
        ...
        // Handle window resize (mobile rotation)
        ...
        const PRIMARY_BREAKDOWN = [
            { name: "Municipal", percentage: 0.77, color: 'var(--color-wrapped-primary)', icon: '🏠' },
            { name: "Education", percentage: 0.22, color: 'var(--color-wrapped-secondary)', icon: '📚' },
            { name: "Newell Fdn", percentage: 0.01, color: 'var(--color-wrapped-tertiary)', icon: '👵' }
        ];
        
        // Departmental Breakdown (of the MUNICIPAL PORTION ONLY - 77% of total tax)
        // Cents are still needed for calculation, but not displayed.
        ...
        window.onload = () => {
            ...
            calculateTaxes();
            updateSlidePosition(); // Set initial slide position and button state
        };
